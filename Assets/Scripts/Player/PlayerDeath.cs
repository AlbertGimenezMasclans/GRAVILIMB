...
public class PlayerDeath : MonoBehaviour
{
    ...
    public IEnumerator RespawnCoroutine()
    {
        ...
        {
            int currentCoinValue = kredsManager.displayedTokens;
            deathUICoinCount.text = currentCoinValue.ToString("D9");
            deathUILostCoins.text = ""; // No mostramos pérdida de Kreds adicional
            ...
            // Hacer al jugador invisible mientras se muestra la UI de muerte
            if (spriteRenderer != null)
            {
                spriteRenderer.enabled = false;
                Debug.Log("Jugador hecho invisible durante la UI de muerte.");
            }

            bool neverCollectedCoins = !hasEverCollectedCoins && currentCoinValue == 0;
        ...
        // Restablecer la vida del jugador al máximo y reiniciar los umbrales
        if (playerHealth != null)
        {
            ...
            playerHealth.ResetThresholds(); // Reiniciar los umbrales de pérdida de Kreds
        }
